...
-- | The type code for the body of the scribble loop.
data ScribbleBody  -- No constructors needed

-- | 'ApplyAB' class models interpretation of function codes like 'ScribbleBody'.
instance Shape s => ApplyAB ScribbleBody s (IO ()) where
  applyAB _ x = do
    draw x
